 ...
 */
attribute_deprecated AVFormatContext* avformat_alloc_output_context(const char* format,
 ...
 */
attribute_deprecated void av_set_pts_info(AVStream* s, int pts_wrap_bits,
