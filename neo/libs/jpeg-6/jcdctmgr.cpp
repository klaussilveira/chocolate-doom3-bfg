    ...
    for (ci = 0, compptr = cinfo->comp_info; ci < cinfo->num_components;
        ...
        case JDCT_ISLOW:
            ...
            if (fdct->divisors[qtblno] == NULL) {
                fdct->divisors[qtblno] = (DCTELEM*)(*cinfo->mem->alloc_small)((j_common_ptr)cinfo, JPOOL_IMAGE,
...
#define CONST_BITS 14
        ...
        case JDCT_FLOAT: {
            ...
            if (fdct->float_divisors[qtblno] == NULL) {
                fdct->float_divisors[qtblno] = (FAST_FLOAT*)(*cinfo->mem->alloc_small)((j_common_ptr)cinfo, JPOOL_IMAGE,
            ...
            for (row = 0; row < DCTSIZE; row++) {
                for (col = 0; col < DCTSIZE; col++) {
                    fdtbl[i] = (FAST_FLOAT)(1.0 / (((double)qtbl->quantval[jpeg_zigzag_order[i]] * aanscalefactor[row] * aanscalefactor[col] * 8.0)));
                    i++;
                }
            }
        } break;
...
jinit_forward_dct(j_compress_ptr cinfo)
{
    ...
    fdct = (my_fdct_ptr)(*cinfo->mem->alloc_small)((j_common_ptr)cinfo, JPOOL_IMAGE,
