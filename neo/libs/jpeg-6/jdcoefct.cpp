...
smoothing_ok(j_decompress_ptr cinfo)
{
    ...
    if (coef->coef_bits_latch == NULL) {
        coef->coef_bits_latch = (int*)(*cinfo->mem->alloc_small)((j_common_ptr)cinfo, JPOOL_IMAGE,
...
jinit_d_coef_controller(j_decompress_ptr cinfo, boolean need_full_buffer)
{
    ...
    coef = (my_coef_ptr)(*cinfo->mem->alloc_small)((j_common_ptr)cinfo, JPOOL_IMAGE,
    ...
    if (need_full_buffer) {
...
#endif
            coef->whole_image[ci] = (*cinfo->mem->request_virt_barray)((j_common_ptr)cinfo, JPOOL_IMAGE, TRUE,
        ...
        buffer = (JBLOCKROW)(*cinfo->mem->alloc_large)((j_common_ptr)cinfo, JPOOL_IMAGE,
