...
jpeg_set_defaults(j_compress_ptr cinfo)
{
    ...
    if (cinfo->comp_info == NULL) {
        cinfo->comp_info = (jpeg_component_info*)(*cinfo->mem->alloc_small)((j_common_ptr)cinfo, JPOOL_PERMANENT,
...
jpeg_simple_progression(j_compress_ptr cinfo)
{
    ...
    scanptr = (jpeg_scan_info*)(*cinfo->mem->alloc_small)((j_common_ptr)cinfo, JPOOL_PERMANENT,
