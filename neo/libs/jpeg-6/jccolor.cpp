...
rgb_ycc_start(j_compress_ptr cinfo)
{
    ...
    cconvert->rgb_ycc_tab = rgb_ycc_tab = (INT32*)(*cinfo->mem->alloc_small)((j_common_ptr)cinfo, JPOOL_IMAGE,
    ...
    JDIMENSION output_row, int num_rows)
{
    ...
    while (--num_rows >= 0) {
        ...
        for (col = 0; col < num_cols; col++) {
            ...
            inptr += RGB_PIXELSIZE;
            /* Y */
            outptr[col] = (JSAMPLE)((ctab[r + R_Y_OFF] + ctab[g + G_Y_OFF] + ctab[b + B_Y_OFF])
                >> SCALEBITS);
        }
    }
}
