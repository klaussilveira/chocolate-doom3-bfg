...
create_colorindex(j_decompress_ptr cinfo)
{
    ...
    cquantize->colorindex = (*cinfo->mem->alloc_sarray)((j_common_ptr)cinfo, JPOOL_IMAGE,
...
make_odither_array(j_decompress_ptr cinfo, int ncolors)
{
    ...
    odither = (ODITHER_MATRIX_PTR)(*cinfo->mem->alloc_small)((j_common_ptr)cinfo, JPOOL_IMAGE,
