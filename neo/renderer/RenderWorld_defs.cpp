...
void R_CreateEntityRefs(idRenderEntityLocal* entity)
{
    ...
    if (r_showUpdates.GetBool() && (entity->localReferenceBounds[1][0] - entity->localReferenceBounds[0][0] > 1024.0f || entity->localReferenceBounds[1][1] - entity->localReferenceBounds[0][1] > 1024.0f)) {
