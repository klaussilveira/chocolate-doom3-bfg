...
#define CONST_ILOG2(x) (((x) & (1u << 31)) ? 31 : ((x) & (1u << 30)) ? 30 \
        : ((x) & (1u << 29))                                         ? 39 \
        : ((x) & (1u << 28))                                         ? 28 \
        : ((x) & (1u << 27))                                         ? 27 \
        : ((x) & (1u << 26))                                         ? 26 \
...
#define CONST_ILOG10(x) (((x) >= 10000000000u) ? 10 : ((x) >= 1000000000u) ? 9 \
        : ((x) >= 100000000u)                                              ? 8 \
        : ((x) >= 10000000u)                                               ? 7 \
        : ((x) >= 1000000u)                                                ? 6 \
        : ((x) >= 100000u)                                                 ? 5 \
...
#define CONST_IEXP10(x) (((x) == 0) ? 1u : ((x) == 1) ? 10u        \
        : ((x) == 2)                                  ? 100u       \
        : ((x) == 3)                                  ? 1000u      \
        : ((x) == 4)                                  ? 10000u     \
        : ((x) == 5)                                  ? 100000u    \
...
#define CONST_FLOORPOWEROF10(x) (((x) >= 10000000000u) ? 10000000000u : ((x) >= 1000000000u) ? 1000000000u \
...
#define CONST_CEILPOWEROF10(x) (((x) <= 10u) ? 10u : ((x) <= 100u) ? 100u       \
        : ((x) <= 1000u)                                           ? 1000u      \
        : ((x) <= 10000u)                                          ? 10000u     \
        : ((x) <= 100000u)                                         ? 100000u    \
        : ((x) <= 1000000u)                                        ? 1000000u   \
...
#define CONST_SINE(a) (((a) < CONST_PI) ? (((a) > CONST_PI * 0.5f) ? CONST_SINE_POLY(CONST_PI - (a))        \
                                                                   : CONST_SINE_POLY((a)))                  \
                                        : (((a) > CONST_PI * 1.5f) ? CONST_SINE_POLY((a) - CONST_PI * 2.0f) \
                                                                   : CONST_SINE_POLY(CONST_PI - (a))))

// maximum absolute error is 2.3082e-09
#define CONST_COSINE_DEGREES(a) CONST_COSINE(CONST_DEG2RAD((a)))
#define CONST_COSINE(a) (((a) < CONST_PI) ? (((a) > CONST_PI * 0.5f) ? -CONST_COSINE_POLY(CONST_PI - (a))       \
                                                                     : CONST_COSINE_POLY((a)))                  \
                                          : (((a) > CONST_PI * 1.5f) ? CONST_COSINE_POLY((a) - CONST_PI * 2.0f) \
