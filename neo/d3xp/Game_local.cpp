...
bool idGameLocal::InhibitEntitySpawn(idDict& spawnArgs)
{
    ...
    if (g_skill.GetInteger() == 3) {
        ...
        if (idStr::Icmp(name, "item_medkit") == 0 || idStr::Icmp(name, "item_medkit_small") == 0 || idStr::Icmp(name, "moveable_item_medkit") == 0 || idStr::Icmp(name, "moveable_item_medkit_small") == 0) {
