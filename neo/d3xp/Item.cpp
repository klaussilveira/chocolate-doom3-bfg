...
bool idItemTeam::Pickup(idPlayer* player)
{
    ...
    if (gameLocal.mpGame.GetGameState() == idMultiplayerGame::WARMUP || gameLocal.mpGame.GetGameState() == idMultiplayerGame::COUNTDOWN)
        return false;
...
void idMoveableItem::Think()
{
    ...
    if (thinkFlags & TH_UPDATEPARTICLES) {
        // Use TIME_GROUP1 (slow time) for smoke particles to ensure proper timing at any framerate
